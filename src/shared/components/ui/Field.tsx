...
const commonFieldClass =
  "w-full min-w-0 rounded-card border border-line bg-panel px-3 py-2 text-sm text-text outline-none transition placeholder:text-subtext/80 focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/25";
