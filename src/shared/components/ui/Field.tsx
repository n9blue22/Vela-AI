...
const commonFieldClass =
  "min-h-[50px] w-full min-w-0 rounded-card border border-line bg-panelAlt/70 px-3 py-3 text-sm text-text outline-none transition placeholder:text-subtext/70 hover:border-primary/30 focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/25";

export function InputField({ label, hint, className, ...props }: InputProps) {
  return (
    <label className="grid min-w-0 gap-1.5">
      <span className="text-sm font-semibold leading-5 text-text">{label}</span>
